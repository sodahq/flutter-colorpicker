...
class ThumbPainter extends CustomPainter {
  const ThumbPainter({this.thumbColor = Colors.grey});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Rect rect = Rect.fromCenter(
      ...
      height: size.width * 1.5 * heightRatio,
    );

    // Đổ màu xám cho hình chữ nhật
    canvas.drawRect(
      rect,
      Paint()
        ..color = thumbColor
